...
The **adapter pattern** is a structural design pattern that let's incompatible interfaces work together and interact.
    ...
    <div style={{ fontFamily: "sans-serif" }}>
      ...
      {data && (
        <div style={{ marginTop: 16, padding: 12, border: "1px solid #ccc", borderRadius: 4 }}>
          <h4>{usingAdapter ? "✅ Modern Format (via Adapter)" : "⚠️ Legacy Format"}</h4>
