...
import BridgeSolutionSvg from "@site/static/img/patterns/structural/bridge/bridge-solution.drawio.svg";
import BridgeProblemSvg from "@site/static/img/patterns/structural/bridge/bridge-problem.drawio.svg";
